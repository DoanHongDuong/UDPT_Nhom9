...
CURRENT_ROLE = "REPLICA"  # Mọi node đều khởi đầu là Replica
...
def check_nodes_and_update_role():
    ...
    if CURRENT_PRIMARY_URL and CURRENT_PRIMARY_URL in alive_nodes:
        ...
        new_primary = min(alive_nodes) # Dùng logic min() để chọn
